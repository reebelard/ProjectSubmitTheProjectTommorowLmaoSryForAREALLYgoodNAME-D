...
while True:
    sleep(0.5)
    print(Fore.GREEN + "\nWhere does your wandering mind want to visit?\n")
    ...
    if choice == "1":
        # output = climage.convert("F:\pics\lal.png")
        print(output)
        print(
            Fore.LIGHTBLUE_EX +
...
{style.UNDERLINE}{Fore.YELLOW}Why visit Lalbagh{style.END}{Fore.LIGHTBLUE_EX}:
...
{style.UNDERLINE}{Fore.YELLOW}Other attractions at Lalbagh{style.END}{Fore.LIGHTBLUE_EX}:
...
{style.UNDERLINE}{Fore.YELLOW}Lalbagh Visiting Hours{style.END}{Fore.LIGHTBLUE_EX}:
...
{style.UNDERLINE}{Fore.YELLOW}Facilities available at Lalbagh{style.END}{Fore.LIGHTBLUE_EX}:
...
{style.UNDERLINE}{Fore.YELLOW}How to reach Lalbagh{style.END}{Fore.LIGHTBLUE_EX}:
...
{style.UNDERLINE}{Fore.YELLOW}Places to stay near Lalbagh{style.END}{Fore.LIGHTBLUE_EX}:
        ...
        print(
            Fore.LIGHTBLUE_EX +
            f"""            Situated to the western of Chord Road on the hill lock known as 'Hare Krishna Hill', 
        ...
        print(
            Fore.LIGHTBLUE_EX +
            f"""            A green haven spread across 300 acres, Cubbon Park provides Bengalureans with a refuge 
...
{style.UNDERLINE}{Fore.YELLOW}Things To Do{style.END}{Fore.LIGHTBLUE_EX}:
...
{style.UNDERLINE}{Fore.YELLOW}Places to visit near Cubbon Park{style.END}{Fore.LIGHTBLUE_EX}:
...
{style.UNDERLINE}{Fore.YELLOW}How to reach{style.END}{Fore.LIGHTBLUE_EX}:
        ...
        print(
            Fore.LIGHTBLUE_EX +
            f"""            It is not in every city that you find a place bestowed with scenic beauty and full of 
    ...
    {style.UNDERLINE}{Fore.BLUE}Activity : Bannerghatta National Park{style.END}{Fore.LIGHTBLUE_EX}
    ...
    {style.UNDERLINE}{Fore.BLUE}Fauna : Bannerghatta National Park{style.END}{Fore.LIGHTBLUE_EX}
    ...
    {style.UNDERLINE}{Fore.BLUE}Flora: Bannerghatta National Park{style.END}{Fore.LIGHTBLUE_EX}
...
{style.UNDERLINE}{Fore.YELLOW}Visiting the Park{style.END}{Fore.LIGHTBLUE_EX}:
        ...
        print(
            Fore.LIGHTBLUE_EX +
            f"""            Located at a distance of only 20 km outside Bengaluru, Turahalli is a sprawling verdant 
    ...
    {style.UNDERLINE}{Fore.YELLOW}1. Nature Walk{style.END}{Fore.LIGHTBLUE_EX}
    ...
    {style.UNDERLINE}{Fore.YELLOW}2.Trekking{style.END}{Fore.LIGHTBLUE_EX}
    ...
    {style.UNDERLINE}{Fore.YELLOW}3.Cycling{style.END}{Fore.LIGHTBLUE_EX}
    ...
    {style.UNDERLINE}{Fore.YELLOW}4.BirdWatching{style.END}{Fore.LIGHTBLUE_EX}
    ...
    {style.UNDERLINE}{Fore.YELLOW}5.Rock Climbing{style.END}{Fore.LIGHTBLUE_EX}
    ...
    {style.UNDERLINE}{Fore.YELLOW}6.Picnic{style.END}{Fore.LIGHTBLUE_EX}
